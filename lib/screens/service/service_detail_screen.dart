...
class _ServiceDetailScreenState extends State<ServiceDetailScreen>
          ...
          children: [
            AnimatedScrollView(
              ...
              children: [
                ...
                _buildVariantOptions(snap.data!.serviceDetail!),
  ...
  Widget _buildVariantOptions(ServiceData serviceData) {
    return Visibility(
      visible: serviceData.attributeValue?.isNotEmpty ?? false,
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              // physics: NeverScrollableScrollPhysics(),
              shrinkWrap: true,
              itemCount: serviceData.attributeValue?.length,
              itemBuilder: (BuildContext context, int index) {
                var indexData = serviceData.attributeValue?[index];
                return Padding(
                  padding: const EdgeInsets.all(5.0),
                  child: ChoiceChip(
                      label: Text(indexData ?? ''),
                      selected: selectedAttribute == indexData ? true : false,
                      onSelected: (ss) {
                        if (ss) {
                          selectedAttribute = indexData ?? '';
                        }
