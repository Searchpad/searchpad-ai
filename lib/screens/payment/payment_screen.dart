...
import '../../services/tap_payment_screen.dart';
...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  void _handleClick() async {
    if (currentPaymentMethod!.type == PAYMENT_METHOD_COD) {
      ...
      ////TAP PAYMENT
    } else if (currentPaymentMethod!.type?.toLowerCase() ==
        PAYMENT_METHOD_TAP) {
      ...
      //   onComplete: (p0) {
      //     savePay(
      //       paymentMethod: PAYMENT_METHOD_TAP,
    ...
    if (widget.bookings.service != null &&
      ...
      if ((widget.bookings.bookingDetail!.paymentStatus == null ||
          ...
          (widget.bookings.bookingDetail!.paidAmount == null ||
              widget.bookings.bookingDetail!.paidAmount.validate() < 1)) {
