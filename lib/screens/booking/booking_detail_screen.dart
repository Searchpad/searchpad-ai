            ...
            children: [
              ...
              Column(
                children: [
                  Row(
                    children: [
                      Text("${bookingDetail.attributeName}: ",
                          style: secondaryTextStyle()),
                      if (bookingDetail.date.validate().isNotEmpty)
                        Text(bookingDetail.attributeValue.validate(),
                            style: boldTextStyle(size: 12)),
                    ],
                  ),
                  8.height,
                ],
              ).visible(bookingDetail.attributeName.validate().isNotEmpty),
              Row(
                children: [
    ...
    return Column(
      ...
      children: [
        ...
        BookingDetailProviderWidget(
          bookingData: res.bookingDetail!,
          providerData: res.providerData!,
          canCustomerContact: canCustomerContact,
          handymanData: res.handymanData?.isEmpty ?? true
              ? null
              : res.handymanData?.first,
          serviceDetail: res.service!,
          onUpdate: () {
            init();
            setState(() {});
          },
    ...
    if ((bookingResponse.service != null &&
      ...
      return Row(
        children: [
          ...
          // ),
          Visibility(
            visible: bookingResponse.bookingDetail!.status ==
      ...
      onAccept: (c) async {
        ...
        if (status.bookingDetail!.isHourlyService) {
          BookingAmountModel bookingAmountModel = finalCalculations(
            ...
            discount: status.service?.discount ?? 0,
