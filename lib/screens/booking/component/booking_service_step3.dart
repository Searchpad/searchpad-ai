...
class BookingServiceStep3 extends StatefulWidget {
  ...
  BookingServiceStep3(
      {required this.data, this.selectedPackage, required this.attributeValue});
...
class _BookingServiceStep3State extends State<BookingServiceStep3> {
  ...
  void applyCoupon() async {
    var value = await showInDialog(
      ...
      builder: (p0) {
        return AppCommonDialog(title: language.lblCoupon, child: EnterCoupon());
      },
    );
                    ...
                    showInDialog(
                      ...
                      builder: (p0) {
                        return ConfirmBookingDialog(
                          attributeValue: widget.attributeValue,
                          data: widget.data,
                          bookingPrice:
