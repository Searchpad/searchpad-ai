...
//TODO: Prem 06-02-2024
  Future<void> bookServices(String attributeValue) async {
    ...
    request.putIfAbsent('attribute_id',
        () => widget.data.serviceDetail?.attributeId.toString());
    request.putIfAbsent('attribute_value', () => attributeValue);

    if (widget.data.serviceDetail != null &&
        widget.data.serviceDetail!.isAdvancePayment) {
      request.putIfAbsent(CommonKeys.status, () => BookingStatusKeys.pending);
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              16.height,
              Text(language.freeCancellation,
              ...
              Row(
                children: [
                  ...
                  AppButton(
                    ...
                    onTap: () {
                      if (isSelected) {
                        bookServices(widget.attributeValue);
                      } else {
