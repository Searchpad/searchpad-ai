...
class _BookingServiceStep2State extends State<BookingServiceStep2> {
  ...
  void selectDateAndTime(BuildContext context) async {
    await showDatePicker(
      ...
      lastDate: currentDateTime.add(Duration(days: 30)),
      ...
      if (date != null) {
        await showTimePicker(
          ...
          if (time != null) {
            ...
            DateTime minAllowedTime = currentDateTime.add(Duration(hours: 12));
            if (finalDate!.isAfter(minAllowedTime)) {
              selectedDate = date;
              pickedTime = time;
              ...
              dateTimeCont.text = "";
              toast(language.selectAfter12Hours);
            }
          }
        }).catchError((e) {
          toast(e.toString());
