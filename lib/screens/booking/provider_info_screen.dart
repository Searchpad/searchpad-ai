...
class ProviderInfoScreenState extends State<ProviderInfoScreen> {
  ...
  Widget productWidget({required list, int? providerId}) {
    return Column(
      children: [
        ViewAllLabel(
          ...
          list: list,
          onTap: () {
            ViewAllProductScreen(providerId: providerId)
                .launch(context, pageRouteAnimation: PageRouteAnimation.Fade);
          },
        ),
        8.height,
        ...
        if (list.isNotEmpty)
          AnimatedWrap(
            ...
            itemBuilder: (_, index) => ProductComponent(
                productData: list[index], width: context.width()),
          )
      ],
    );
  }
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Visibility(
                          visible: data.product?.isNotEmpty ?? false,
                          child: Column(
                            children: [
                              productWidget(
                                  list: data.product,
