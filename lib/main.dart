...
import 'package:booking_system_flutter/model/product_detail_model.dart' as prod;
...
import 'package:booking_system_flutter/services/no_internet_connection_service.dart';
...
List<(int productId, prod.ProductDetailModel list)?> listOfProductCachedData =
    [];
